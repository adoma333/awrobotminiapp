...
export default function WhatsNew({ t, lang, ann, onClose }) {
  ...
  return (
    <div className={`wn-backdrop ${leaving ? 'is-leaving' : ''}`} onClick={(e) => e.target === e.currentTarget && close('close')}>
      <section className="wn-sheet" role="dialog" aria-modal="true" aria-labelledby="wn-title">
